...
class ObstacleAvoidance {
    ...
    protected: // ROS Callbacks
        ...
        // void current_velocity_cb(const geometry_msgs::TwistConstPtr msg) {
        //     // current_velocity_ = *msg;
        // }

        void odom_velocity_cb(const nav_msgs::OdometryConstPtr msg) {
    ...
    public:
        ObstacleAvoidance() : nh_("~") {
            ...
            scan_sub_ = nh_.subscribe("scans",1,&ObstacleAvoidance::scan_callback,this);
            // current_vel_sub_ = nh_.subscribe("current_velocity",1,&ObstacleAvoidance::current_velocity_cb,this);
            odom_vel_sub_ = nh_.subscribe("/odom",1,&ObstacleAvoidance::odom_velocity_cb,this);
